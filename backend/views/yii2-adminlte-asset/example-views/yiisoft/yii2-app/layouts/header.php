                        ...
                        <li>
                            ...
                            <ul class="menu">
                                ...
                                foreach ($comments as $comment)
                                {
                                    ...
                                    $status = Yii::$app->mycomponent->getStatus($comment['status']);

                                    $time = \Yii::$app->jdf->jdate($format = 'Y/F/j', $timestamp = $time, $none = '', $time_zone = 'Asia/Tehran', $tr_num = 'fa');
                                    ?>
                                    <li>
                ...
                <li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-header">
                            <img src="<?php echo $base; ?>/img/user2-160x160.jpg" class="img-circle"
                                 alt="User Image"/>
