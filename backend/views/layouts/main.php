...
<meta charset="<?= Yii::$app->charset ?>">
  ...
  <!-- CSS Files -->
  <link href="../web/assets/css/black-dashboard.css?v=1.0.0" rel="stylesheet" />
  <link href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-rtl/3.4.0/css/bootstrap-rtl.css" rel="stylesheet" />
  <!-- CSS Just for demo purpose, don't include it in your project -->
  <link href="../web/assets/demo/demo.css" rel="stylesheet" />
  <link href="../web/assets/css/mrh.css" rel="stylesheet" />
</head>
...
<?= $content ?>
  ...
  <script src="../web/assets/js/black-dashboard.min.js?v=1.0.0"></script>
