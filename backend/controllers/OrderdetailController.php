...
class OrderdetailController extends Controller
    ...
    public function actionIndex()
        ...
        if (isset($_GET['id']))
            ...
            $id = $_GET['id'];
            $s['SleOrderDetailSearch']['orderID'] = $id;
        ...
        if ($request->isAjax)
            ...
            if ($request->isGet)
                ...
                return [
                    ...
                    'title' => "Create new SleOrderDetail",
                    'content' => '<span class="text-success">Create SleOrderDetail success</span>',
                    'footer' => Html::button('Close', ['class' => 'btn btn-default pull-left', 'data-dismiss' => "modal"]) .
     ...
     * @param integer $id
     * @return SleOrderDetail the loaded model
